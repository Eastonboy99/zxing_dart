 ...
 */
 class AlignmentPatternFinder {
  ...
  List<AlignmentPattern> _possibleCenters;
  final int _startX;
  final int _startY;
  final int _width;
  final int _height;
   ...
   */
  AlignmentPatternFinder(this._image,
                         this._startX,
                         this._startY,
                         this._width,
                         this._height,
    ...
    this._possibleCenters = new List(5);
    
    this._crossCheckStateCount = new List<int>(3);
  }
  ...
  AlignmentPattern find() {
    ...
    List<int> stateCount = new List<int>(3);
        ...
        if (_image.get(j, i)) {
          ...
          if (currentState == 1) { // Counting black pixels
            ...
            if (currentState == 2) { // A winner?
              if (_foundPatternCross(stateCount)) { // Yes
                AlignmentPattern confirmed = _handlePossibleCenter(stateCount, i, j);
                if (confirmed != null) {
                  return confirmed;
                }
              }
  ...
  double _crossCheckVertical(int startI, int centerJ, int maxCount,
    ...
    return _foundPatternCross(stateCount) ? _centerFromEnd(stateCount, i) : double.nan;
  }
  ...
  AlignmentPattern _handlePossibleCenter(List<int> stateCount, int i, int j) {
    ...
    double centerI = _crossCheckVertical(i, centerJ.toInt(), 2 * stateCount[1], stateCountTotal);
    if (!(centerI).isNaN) {
