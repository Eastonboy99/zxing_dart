...
class DataBlock {
  ...
  DataBlock(this._numDataCodewords, this._codewords);
   ...
   *         QR Code
   */
  static List<DataBlock> getDataBlocks(Uint8List rawCodewords,
                                   Version version,
    ...
    List<DataBlock> result = new List<DataBlock>(totalBlocks);
    int numResultBlocks = 0;
    for (ECB ecBlock in ecBlockArray) {
      for (int i = 0; i < ecBlock.getCount(); i++) {
        int numDataCodewords = ecBlock.getDataCodewords();
        int numBlockCodewords = ecBlocks.getECCodewordsPerBlock() + numDataCodewords;
        result[numResultBlocks++] = new DataBlock(numDataCodewords, new Uint8List(numBlockCodewords));
      }
    }
