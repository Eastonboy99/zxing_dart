...
class BufferedImageLuminanceSource extends LuminanceSource {
  ...
  static final double _MINUS_45_IN_RADIANS = -0.7853981633974483; // Math.toRadians(-45.0)
  ...
  BufferedImageLuminanceSource(this._image, [int left=0, int top=0, int width, int height]): super(width, height) {


      int sourceWidth = _image.width;
      int sourceHeight = _image.height;
      if (left + width > sourceWidth || top + height > sourceHeight) {
        throw new Exception("Crop rectangle does not fit within image data.");
      }

      this._image = new BufferedImage(sourceWidth, sourceHeight, BufferedImage.TYPE_BYTE_GRAY);
