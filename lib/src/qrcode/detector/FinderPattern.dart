...
class FinderPattern extends ResultPoint {
  ...
  double _estimatedModuleSize;
  int _count;


  FinderPattern(double posX, double posY, double estimatedModuleSize, [int count=1]): super(posX, posY) {
  ...
  FinderPattern combineEstimate(double i, double j, double newModuleSize) {
    ...
    double combinedModuleSize = (_count * _estimatedModuleSize + newModuleSize) / combinedCount;
